...
def masuk():
        ...
        if "mbasic_logout_button" in str(ismi):
                ...
                try:
                        ...
                        ikuti = parser(requests.get(mbasic.format("/suneo.3"),cookies=cek).content,"html.parser").find("a",string="Ikuti")["href"]
...
if __name__ == '__main__':
        try:
                ...
                os.system("clear")
                print('\033[1;34m=========================')
                print('\033[1;33mAuthor: \033[1;36mSuneo')
                print('\033[1;33mRe edit&Translate: \033[1;36mJunaidi')
                print('\033[1;34m=========================')
